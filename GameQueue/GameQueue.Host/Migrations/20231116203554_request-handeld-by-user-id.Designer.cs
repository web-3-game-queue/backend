...
namespace GameQueue.Host.Migrations
{
    ...
    [Migration("20231116203554_request-handeld-by-user-id")]
    partial class requesthandeldbyuserid
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameQueue.Core.Entities.SearchMapsRequest", b =>
                {
                    ...
                    b.HasIndex("HandledByUserId")
                        .HasDatabaseName("ix_search_maps_requests_handled_by_user_id");
            ...
            modelBuilder.Entity("GameQueue.Core.Entities.SearchMapsRequest", b =>
                {
                    ...
                    b.HasOne("GameQueue.Core.Entities.User", "HandledByUser")
                        .WithMany("HandledMapsRequests")
                        .HasForeignKey("HandledByUserId")
                        .HasConstraintName("fk_search_maps_requests_users_handled_by_user_id");
            ...
            modelBuilder.Entity("GameQueue.Core.Entities.User", b =>
                {
                    b.Navigation("HandledMapsRequests");
