        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_map_search_requests_maps_map_id",
                        column: x => x.map_id,
                        principalTable: "maps",
                        principalColumn: "id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_request_to_maps_map_search_requests_search_request_id",
                        column: x => x.search_request_id,
                        principalTable: "map_search_requests",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "ix_map_search_requests_map_id",
                table: "map_search_requests",
                column: "map_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_request_to_maps_search_request_id",
                table: "request_to_maps",
